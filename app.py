...
def css_relatorio():
    ...
    .page{background:white;max-width:1100px;margin:auto;padding:35px;border-radius:18px}
    ...
    if docs:
        ...
        if html_docs:
            ...
            <div class="bloco">
                ...
                <p class="subinfo">Itens localizados no edital, organizados por categoria. O sistema não adiciona documentos que não estejam no texto analisado.</p>
                {html_docs}
            </div>
            """
    ...
    if exig:
        ...
        if html_exig:
            ...
            <div class="bloco">
                ...
                <p class="subinfo">Exigências localizadas no edital, organizadas por categoria. O sistema não presume exigências.</p>
                {html_exig}
            </div>
            """
